...
A aplicação funciona da mesma forma que o método *Pomodoro*: a cada 25 minutos, há um contador para que se possa fazer uma pausa e realizar alguns exercícios propostos na aplicação.
