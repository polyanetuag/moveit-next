...
A aplicação funciona da mesma forma que o método *Pomodoro*: a cada 25 minutos, há um timer para que se possa realizar uma pausa e fazer os exercícios que estão propostos na aplicação.
